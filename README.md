...
| File name                                                                                                                                                  | Platform    |
|------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|
| [cameraman-v1.4.0-alpha5-windows-amd64.zip](https://github.com/borogk/cameraman/releases/download/v1.4.0-alpha5/cameraman-v1.4.0-alpha5-windows-amd64.zip) | Windows x64 |
| [cameraman-v1.4.0-alpha5-linux-amd64.zip](https://github.com/borogk/cameraman/releases/download/v1.4.0-alpha5/cameraman-v1.4.0-alpha5-linux-amd64.zip)     | Linux x64   |
| [cameraman-v1.4.0-alpha5-macos-arm64.zip](https://github.com/borogk/cameraman/releases/download/v1.4.0-alpha5/cameraman-v1.4.0-alpha5-macos-arm64.zip)     | macOS ARM64 |
